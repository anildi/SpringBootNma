...
public class JPATrackDAO implements BaseDAO<Track> {
    ...
    /**
     * SQL Injectable.
     * This should only let you select by title.  To
     * make it break, try it with
     * @param title
     * @return
     */
     ...
     * Which is still ugly, but probably better.
     *
     * @param example
     * @return
     */
...
//        System.out.println("Criteria query: " + sql);
    ...
    public String getCriteriaQuerySql(Criteria cq) {
        CriteriaImpl criteriaImpl = (CriteriaImpl)cq;
