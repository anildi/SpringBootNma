...
//No DirtiesContext nonsense needed here.
//We can either create the DB each time with @Sql as here
//@Sql(scripts = {"/schema.sql", "/data.sql"}, executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)

//Or Use @Transactional to *Rollback* the transaction after each method.
//That's how it works on a test.
@Transactional
