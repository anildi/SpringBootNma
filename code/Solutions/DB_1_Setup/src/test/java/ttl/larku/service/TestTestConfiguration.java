 ...
 * You *have* to mark your bean as @Primary to avoid
 * injection errors.
 * You also *have* to set the property spring.main.allow-bean-definition-overriding=true.
 * This can be done in the @SpringBootTest annotation.
 */
