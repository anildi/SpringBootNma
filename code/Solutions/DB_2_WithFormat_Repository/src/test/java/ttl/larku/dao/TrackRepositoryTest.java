...
public class TrackRepositoryTest {
    ...
    public static void runSqlScriptsOnce(@Autowired DataSource dataSource) throws SQLException {
        try (Connection conn = dataSource.getConnection()) {
            ScriptUtils.executeSqlScript(conn, new ClassPathResource("schema-withformat.sql"));
            ScriptUtils.executeSqlScript(conn, new ClassPathResource("data-withformat.sql"));
        }
    }
